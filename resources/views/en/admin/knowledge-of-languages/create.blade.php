...
@section('content')
    ...
    <form action="{{ route('knowledge-of-languages.store') }}" method="POST">
        ...
        <div class="form-group">
            <label>{{ __('knowledge-of-languages-language-en') }}</label>
        ...
        <div class="form-group">
            <label>{{ __('knowledge-of-languages-language-uk') }}</label>
            <input type="text" class="form-control" name="languageuk" value="{{ old('languageuk') }}"
                   placeholder="{{ __('knowledge-of-enter-languages-language-uk') }}" required>
        </div>

        <div class="form-group">
            <label>{{ __('knowledge-of-languages-language-ru') }}</label>
            <input type="text" class="form-control" name="languageru" value="{{ old('languageru') }}"
                   placeholder="{{ __('knowledge-of-enter-languages-language-ru') }}" required>
        </div>
        ...
        <div class="form-group">
            <label>{{ __('admin.knowledge-of-languages-status') }}</label>
