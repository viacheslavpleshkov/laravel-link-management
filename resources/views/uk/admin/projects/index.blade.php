    ...
    <div class="row justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-lg-3">
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('projects.create') }}">{{ __('admin.create-projects') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
            ...
            <tr>
                ...
                <th scope="col">{{ __('admin.projects-title') }}</th>
                <th scope="col">{{ __('admin.projects-url') }}</th>
                <th scope="col">{{ __('admin.projects-status') }}</th>
                <th scope="col"></th>
            </tr>
            </thead>
            <tbody>
