...
@section('title',__('admin.about-me'))
    ...
    <div class="row justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-lg-3">
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('about-me.create') }}">{{ __('admin.create-about-me') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table id="datatable" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th scope="col">{{ __('admin.about-me-uk') }}</th>
                <th scope="col">{{ __('admin.about-me-status') }}</th>
                <th scope="col"></th>
            </tr>
            </thead>
            <tbody>
            @foreach($main as $item)
                <tr>
                    ...
                    <td scope="row">{{ $item->aboutmeuk }}</td>
                    <td scope="row">
                        @if($item->status)
                            {{ __('admin.enabled') }}
                        @else
